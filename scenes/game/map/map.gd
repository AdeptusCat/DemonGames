...
#	var fxScene = ResourceLoader.load_threaded_get(map_fx_path)
	...
	if OS.has_feature("editor"):
		if not Settings.debug:
			var fx = load("res://scenes/game/map/map_fx/map_fx.tscn")
...
func buildCircles():
	var polygon_filenames : Array = [
		"res://scenes/game/map/map_fx/player_polygons/neutral_polygons.tscn",
		"res://scenes/game/map/map_fx/player_polygons/node_2d.tscn",
		"res://scenes/game/map/map_fx/player_polygons/player_1_polygons.tscn",
		"res://scenes/game/map/map_fx/player_polygons/player_1_polygons_2.tscn",
		"res://scenes/game/map/map_fx/player_polygons/player_1_polygons_3.tscn",
		"res://scenes/game/map/map_fx/player_polygons/player_1_polygons_4.tscn",
		"res://scenes/game/map/map_fx/player_polygons/player_1_polygons_5.tscn"
	]
...
func placeFirstLegion():
	print("placing first legion ",Data.id , " ", Connection.host)
