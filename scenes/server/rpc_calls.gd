...
const playerScene = preload("res://scenes/game/player/player.tscn")
const demonScene = preload("res://scenes/game/demon/demon.tscn")
...
func checkEndPhaseCondition():
	if Data.player.arcanaCards.size() > 5:
		...
		#print("hide arcana - checkEndPhaseCondition")
...
func addDemon(id : int, DemonName : String, savegame : Dictionary = {}):
	...
	demon.stats = load("res://assets/demons/resources/" + DemonName)
	demon.loadStats()
