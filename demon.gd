...
const maleTexture = preload("res://assets/demon_genders/male.png")
const femaleTexture = preload("res://assets/demon_genders/female.png")
const hermaphroditeTexture = preload("res://assets/demon_genders/male_female.png")
const undefinedTexture = preload("res://assets/demon_genders/undefined.png")
